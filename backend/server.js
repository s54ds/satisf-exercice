...
async function initialiserServeur() {
    try {
        ...
        try {
            ...
            console.warn('⚠️ Impossible de nettoyer les sessions:', erreurNettoyage.message);
        }
        ...
        const serveur = app.listen(PORT, HOST, () => {
            ...
            console.log(`❤️ Santé: http://${HOST}:${PORT}/api/health`);
        ...
        const arreterServeur = (signal) => {
            ...
            serveur.close(async (err) => {
                ...
                try {
                    ...
                    console.error('⚠️ Erreur fermeture DB:', erreurDB.message);
                }
...
// Fonction d'aide pour le démarrage
